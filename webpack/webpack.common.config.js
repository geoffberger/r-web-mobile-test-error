...
const shouldIncludeJS = modulePath => {
  return modulePath.indexOf(libDir) > -1 && !shouldIncludeTestFiles(modulePath);
}
...
module.exports = {
  ...
  entry: {
    ...
    earlyaccess: helpers.entryPoint('earlyaccess'),
    beautyshop: helpers.entryPoint('beautyshop')
  },
